package co.com.aws.encuentasAws.security;
...
public class AwsCognitoJwtAuthenticationFilter extends GenericFilterBean {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain)
		...
		try {
			...
			System.out.println("el token es: "+ tokenJWT);
	...
	private static List<GrantedAuthority> convertirLista(List<String> rolesCognito) {
		...
		if(listaRolesSpring.isEmpty()) {
			listaRolesSpring.add(new SimpleGrantedAuthority(PREFIX_ROLE + "USER"));
		}
